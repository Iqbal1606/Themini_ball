...
$produk = mysqli_query($conn, "SELECT * FROM produk_hoddie where id_hoddie= $id_produk");
        ...
        <div class="container">
          <div class="row">
            ...
            <img src="../admin/gambar/<?php echo $data["gambar"] ?>" alt="" class="img-responsive">
              ...
              <div class="col-md-6">
              <h1>DETAIL PRODUK</h1>
              <H2>"<?php echo $data["nama_hoddie"] ?>"</H2>
              <h4> Rp<?php echo number_format($data['harga_hoddie']) ?></h4>
              <h5>Keterangan:</h5>
              <h5><?php echo $data["deskripsi_hoddie"] ?></h5>
