<?php
include "../../koneksi.php";
$sql = "SELECT * FROM produk_hoddie order by id_hoddie ASC ";
                                ...
                                <div class="d-sm-flex justify-content-between align-items-center">
                                    ...
                                    <div class="data-tables datatable-dark">
										 <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
                                            ...
                                            <tr>
                                                <td><?php echo $no; ?></td>
                                                <td><?php echo $data['nama_hoddie']; ?></td>
                                                <td><?php echo $data['deskripsi_hoddie']; ?></td>
                                                <td>Rp <?php echo number_format($data['harga_hoddie']); ?></td>
                                                <td><img src="../gambar/<?php echo $data['gambar'] ?>" width="20%"\></td>
                                                <td>
                                                    <a href="update.php?id=<?php echo $data['id_hoddie']; ?>">Edit</a> |
                                                    <a href="delete.php?idcrewneck=<?php echo $data['id_hoddie'];?>" onclick="return confirm('Anda yakin akan menghapus data ini?')">Hapus</a>
					...
					<div class="modal-content">
						...
						<form action="" method="post" enctype="multipart/form-data" >
								<div class="form-group">
									<label>Nama Hoddie</label>
									<input name="nama_hoddie" type="text" class="form-control" required autofocus>
								</div>
							
								<div class="form-group">
									<label>Deskripsi</label>
									<input name="deskripsi_hoddie" type="text" class="form-control" required>
								</div>
								<div class="form-group">
									<label>Harga Produk</label>
									<input name="harga_hoddie" type="number" class="form-control">
								</div>
                                <div class="form-group">
									<label>Gambar</label>
                        ...
                        $nama_crewneck = $_POST['nama_hoddie'];
                        $deskripsi_crewneck = $_POST['deskripsi_hoddie'];
                        $harga_crewneck = $_POST['harga_hoddie'];
                        ...
                        if ($foto_size > 2097152) {
                            ...
                            if ($gambar != "") {
                                ...
                                if(in_array($ekstensi, $ekstensi_izin) === true)  {
                                    ...
                                    $query = mysqli_query($conn, "INSERT INTO produk_hoddie VALUES ('','$nama_crewneck', '$deskripsi_crewneck', '$harga_crewneck', '$foto_nama_new')");

                                    // Mengecek apakah data gagal diinput atau tidak
                                    if($query){
                                        echo "<br><meta http-equiv='refresh' content='5; URL=../produkhoddie/'> You will be redirected to the form in 1 seconds";
                                    } else {
