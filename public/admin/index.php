...
<?php
include "../koneksi.php";
// $id_admin=$_SESSION['usename_admin'];
...
<?php
include "../koneksi.php";
$data_produk = mysqli_query($conn, "SELECT * FROM `produk_crewneck`");
$jumlah_produk = mysqli_num_rows ($data_produk);
$data_hoddie = mysqli_query($conn, "SELECT * FROM `produk_hoddie`");
$jumlah_hoddie = mysqli_num_rows ($data_hoddie);
?>
<!doctype html>
<html lang="en">
<head>
                        ...
                        <div class="col-md-4">
                            <div class="single-report">
                                <div class="s-report-inner pr--20 pt--30 mb-3">
                                    ...
                                    <div class="s-report-title d-flex justify-content-between">
                                        <h4 class="header-title mb-0">Produk Crewneck</h4>
                                    </div>
                                    <div class="d-flex justify-content-between pb-2">
                                    ...
                                    <br>
                                    <div class="s-report-title d-flex justify-content-between">
                                        <h4 class="header-title mb-0">Produk Hoddie</h4>
                                    </div>
                                    <div class="d-flex justify-content-between pb-2">
                                        <h1><?php echo $jumlah_hoddie?></h1>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="market-status-table mt-4">
                                    Anda masuk sebagai <strong><?php echo $data['username_admin']; ?> </strong>
									<br>
